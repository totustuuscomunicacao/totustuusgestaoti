...
/**
 * TOTUSTUUS | Class ClientModel Active Record Pattern
 *
...
class ClientModel extends Model
{
    ...
    {
        parent::__construct("client", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findClient(?string $terms = null, ?string $params = null, string $columns = "*")
    {
