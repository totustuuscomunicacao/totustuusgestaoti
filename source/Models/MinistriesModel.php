...
/**
 * TOTUSTUUS | Class MinistriesModel Active Record Pattern
 *
 * @author Jefferson A. G. Silva <contato@totustuuscomunicacao.com.br>
 * @package Source\Models
 */
class MinistriesModel extends Model
{
    /**
     * MinistriesModel constructor.
     */
    public function __construct()
    {
        parent::__construct("ministries", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findMinistries(?string $terms = null, ?string $params = null, string $columns = "*")
    {
