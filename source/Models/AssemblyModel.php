...
/**
 * TOTUSTUUS | Class AssemblyModel Active Record Pattern
 *
...
class AssemblyModel extends Model
{
    ...
    {
        parent::__construct("assembly", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findAssembly(?string $terms = null, ?string $params = null, string $columns = "*")
    {
