...
/**
 * TOTUSTUUS | Class SpouseModel Active Record Pattern
 *
...
{
    /**
     * SpouseModel constructor.
     */
    public function __construct()
    {
        parent::__construct("spouse", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findSpouse(?string $terms = null, ?string $params = null, string $columns = "*")
    {
