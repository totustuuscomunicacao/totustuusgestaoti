...
/**
 * TOTUSTUUS | Class ChurchModel Active Record Pattern
 *
...
{
    /**
     * ChurchModel constructor.
     */
    public function __construct()
    {
        parent::__construct("church", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findChurch(?string $terms = null, ?string $params = null, string $columns = "*")
    {
