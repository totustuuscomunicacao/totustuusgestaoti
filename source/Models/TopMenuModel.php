...
/**
 * TOTUSTUUS | Class TopMenuModel Active Record Pattern
 *
...
{
    /**
     * TopMenuModel constructor.
     */
    public function __construct()
    {
        parent::__construct("top_menu", ["id"], ["id_entity", "id_modules", "id_settings_namespace", 
     ...
     * @return mixed|Model
     */
    public function findTopMenu(?string $terms = null, ?string $params = null, string $columns = "*")
    {
     ...
     */
    public function TopMenuToIcons(): ?SettingsIconsModel
    {
        if ($this->id_icons) {
     ...
     */
    public function TopMenuToSettingsRoute(): ?SettingsRouteModel
    {
