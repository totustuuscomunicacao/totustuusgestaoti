...
/**
 * TOTUSTUUS | Class SonsModel Active Record Pattern
 *
 * @author Jefferson A. G. Silva <contato@totustuuscomunicacao.com.br>
 * @package Source\Models
 */
class SonsModel extends Model
{
    /**
     * SonsModel constructor.
     */
    public function __construct()
    {
        parent::__construct("sons", ["id"], ["id_people", 
     ...
     * @return mixed|Model
     */
    public function findSons(?string $terms = null, ?string $params = null, string $columns = "*")
    {
